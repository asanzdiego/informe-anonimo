...
Desarrollo evolutivo y correctivo de las Aulas Virtuales, la Mediateca, las webs de centro, el correo web, EMPieza y otras aplicaciones de EducaMadrid (BAC07_2026)
...
Asimismo, la propuesta evidencia una **comprensión profunda del entorno técnico y operativo del contrato**, lo que se traduce en la adopción de **soluciones realistas y alineadas con la arquitectura existente**. Este aspecto resulta especialmente relevante en un sistema caracterizado por la coexistencia de múltiples sistemas y la necesidad de garantizar la continuidad del servicio. La propuesta evita planteamientos disruptivos o no alineados con el entorno, priorizando la **integración controlada y la evolución progresiva del sistema**.
...
Asimismo, se propone la **continuación del procedimiento con empresa_s**, única licitadora que ha superado el umbral mínimo exigido, al acreditar un nivel técnico suficiente y adecuado a los requisitos del contrato.
