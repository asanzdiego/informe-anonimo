...
La propuesta presenta un desarrollo técnico muy limitado y desigual. Una parte sustancial de los proyectos aparece solo mencionada o marcada como pendiente de una versión futura; no se aportan arquitecturas completas, secuencias de implantación, integraciones, métricas ni mecanismos de validación suficientes. Se reconocen referencias conceptuales a metodología, riesgos y calidad y algún desarrollo general en proyectos concretos, pero no permiten acreditar la cobertura ni la viabilidad global.

### Principales conclusiones del análisis

TRA recibe un tratamiento general; AV y MED contienen numerosos apartados pendientes; COR, CLO, VID y la mayoría de servicios unitarios y complementarios se limitan a menciones; WEK queda íntegramente pendiente. La falta de finalización y de adaptación al entorno es transversal, no una deficiencia aislada.
...
La memoria no puede considerarse finalizada: incluye anotaciones de desarrollo futuro y amplias zonas sin solución concreta. La exposición metodológica tiene cierta calidad formal, pero no existe una relación operativa completa entre requisitos, arquitectura, tareas y planificación. La ausencia de evidencias verificables impide confirmar la viabilidad de gran parte del alcance.
...
Se reconoce un desarrollo general en TRA y en algunos proyectos de AV, MED, WPM, LDAP, BUS1, ALB e IFZ, además de referencias conceptuales a metodología, riesgos y calidad. Son aportaciones parciales que justifican puntuación distinta de cero.

#### Carencias, errores y riesgos recurrentes

Predominan las menciones sin desarrollo y los contenidos pendientes. Faltan arquitectura, desglose de tareas, cronograma, dependencias, hitos, recursos, métricas, criterios de aceptación y procedimientos de recuperación verificables. La cobertura efectiva y la trazabilidad son, por ello, muy reducidas.
...
El bloque exige resolver identidad, sincronización, interoperabilidad, seguridad y servicios comunes. Los ocho proyectos reciben un desarrollo general, sin el desglose técnico y la trazabilidad necesarios para una valoración superior.
...
El contraste individual recogido en el anexo identifica 8 proyectos con desarrollo suficiente, 0 con desarrollo insuficiente y 0 sin solución concreta. Los ocho proyectos reciben un desarrollo general, sin el desglose técnico y la trazabilidad necesarios para una valoración superior.

###### Fortalezas y valor añadido

Se reconoce contenido evaluable en 8 proyectos, que permite asignar valor parcial sin extenderlo a los proyectos no desarrollados.
...
La clasificación del anexo y las evidencias anteriores sitúan el bloque en un nivel **BAJA**. Los ocho proyectos reciben un desarrollo general, sin el desglose técnico y la trazabilidad necesarios para una valoración superior.
...
El bloque exige resolver evolución de Moodle, integraciones, rendimiento, seguridad, escalabilidad y continuidad. Quince proyectos quedan pendientes, AV12 solo se menciona y únicamente cinco presentan algún desarrollo general.
...
**Análisis de la propuesta.** El contraste individual recogido en el anexo identifica 5 proyectos con desarrollo suficiente, 1 con desarrollo insuficiente y 15 sin solución concreta. Quince proyectos quedan pendientes, AV12 solo se menciona y únicamente cinco presentan algún desarrollo general.

**Fortalezas y valor añadido.** Se reconoce contenido evaluable en 5 proyectos, que permite asignar valor parcial sin extenderlo a los proyectos no desarrollados.

**Carencias, omisiones, errores o riesgos.** 1 proyecto presenta desarrollo genérico o incompleto; 15 carecen de solución concreta. Estas limitaciones reducen la concreción, viabilidad o verificabilidad del bloque.

**Valoración cualitativa: MUY BAJA.** El nivel **MUY BAJA** refleja la relación entre la cobertura efectiva, la profundidad técnica, las mejoras y las carencias acreditadas para el bloque.

##### Integración, rendimiento, escalabilidad y continuidad del servicio

No se definen de forma suficiente los flujos, integraciones, cargas, mecanismos de monitorización y recuperación necesarios para comprobar el comportamiento del bloque en operación.

##### Conclusión del bloque AV

La clasificación del anexo y las evidencias anteriores sitúan el bloque en un nivel **MUY BAJA**. Quince proyectos quedan pendientes, AV12 solo se menciona y únicamente cinco presentan algún desarrollo general.
...
El bloque exige resolver procesamiento multimedia, subtitulado, búsqueda, almacenamiento, distribución e integración. Siete proyectos quedan pendientes, MED11 solo se menciona y MED1, MED2 y MED10 contienen desarrollo general parcial.
...
**Análisis de la propuesta.** El contraste individual recogido en el anexo identifica 3 proyectos con desarrollo suficiente, 1 con desarrollo insuficiente y 7 sin solución concreta. Siete proyectos quedan pendientes, MED11 solo se menciona y MED1, MED2 y MED10 contienen desarrollo general parcial.

**Fortalezas y valor añadido.** Se reconoce contenido evaluable en 3 proyectos, que permite asignar valor parcial sin extenderlo a los proyectos no desarrollados.

**Carencias, omisiones, errores o riesgos.** 1 proyecto presenta desarrollo genérico o incompleto; 7 carecen de solución concreta. Estas limitaciones reducen la concreción, viabilidad o verificabilidad del bloque.
...
La clasificación del anexo y las evidencias anteriores sitúan el bloque en un nivel **MUY BAJA**. Siete proyectos quedan pendientes, MED11 solo se menciona y MED1, MED2 y MED10 contienen desarrollo general parcial.
...
El bloque exige resolver evolución del correo, funciones de inteligencia artificial, seguridad e integración. Los cuatro proyectos se mencionan sin una solución técnica completa para mantenimiento, IA, seguridad e integración.
...
**Análisis de la propuesta.** El contraste individual recogido en el anexo identifica 0 proyectos con desarrollo suficiente, 4 con desarrollo insuficiente y 0 sin solución concreta. Los cuatro proyectos se mencionan sin una solución técnica completa para mantenimiento, IA, seguridad e integración.
...
La clasificación del anexo y las evidencias anteriores sitúan el bloque en un nivel **MUY BAJA**. Los cuatro proyectos se mencionan sin una solución técnica completa para mantenimiento, IA, seguridad e integración.
...
El bloque exige resolver almacenamiento, sincronización, edición colaborativa, seguridad y rendimiento. CLO1 y CLO2 aparecen citados, pero sin arquitectura, procesos ni mecanismos de implementación evaluables.
...
**Análisis de la propuesta.** El contraste individual recogido en el anexo identifica 0 proyectos con desarrollo suficiente, 2 con desarrollo insuficiente y 0 sin solución concreta. CLO1 y CLO2 aparecen citados, pero sin arquitectura, procesos ni mecanismos de implementación evaluables.
...
La clasificación del anexo y las evidencias anteriores sitúan el bloque en un nivel **MUY BAJA**. CLO1 y CLO2 aparecen citados, pero sin arquitectura, procesos ni mecanismos de implementación evaluables.
...
El bloque exige resolver mantenimiento, licencias, protección perimetral, antiabuso y autenticación. WPM3 y WPM5 presentan desarrollo general en seguridad y operación; WPM1, WPM2 y WPM4 se limitan a menciones.
...
**Análisis de la propuesta.** El contraste individual recogido en el anexo identifica 2 proyectos con desarrollo suficiente, 3 con desarrollo insuficiente y 0 sin solución concreta. WPM3 y WPM5 presentan desarrollo general en seguridad y operación; WPM1, WPM2 y WPM4 se limitan a menciones.
...
**Carencias, omisiones, errores o riesgos.** 3 proyectos presentan desarrollo genérico o incompleto. Estas limitaciones reducen la concreción, viabilidad o verificabilidad del bloque.
...
La clasificación del anexo y las evidencias anteriores sitúan el bloque en un nivel **BAJA**. WPM3 y WPM5 presentan desarrollo general en seguridad y operación; WPM1, WPM2 y WPM4 se limitan a menciones.
...
El bloque exige resolver integración educativa, concurrencia, calidad, grabaciones y continuidad. VID1 a VID4 se mencionan sin desarrollo completo sobre integración, rendimiento, grabaciones y alta concurrencia.
...
**Análisis de la propuesta.** El contraste individual recogido en el anexo identifica 0 proyectos con desarrollo suficiente, 4 con desarrollo insuficiente y 0 sin solución concreta. VID1 a VID4 se mencionan sin desarrollo completo sobre integración, rendimiento, grabaciones y alta concurrencia.
...
La clasificación del anexo y las evidencias anteriores sitúan el bloque en un nivel **MUY BAJA**. VID1 a VID4 se mencionan sin desarrollo completo sobre integración, rendimiento, grabaciones y alta concurrencia.
...
El bloque exige resolver los requisitos específicos y diferenciados de los seis servicios unitarios. LDAP y BUS1 contienen desarrollo general; EMP1, EXE, FOR1 y ANI1 se limitan a menciones no evaluables.
...
**Análisis de la propuesta.** El contraste individual recogido en el anexo identifica 2 proyectos con desarrollo suficiente, 4 con desarrollo insuficiente y 0 sin solución concreta. LDAP y BUS1 contienen desarrollo general; EMP1, EXE, FOR1 y ANI1 se limitan a menciones no evaluables.
...
La clasificación del anexo y las evidencias anteriores sitúan el bloque en un nivel **BAJA**. LDAP y BUS1 contienen desarrollo general; EMP1, EXE, FOR1 y ANI1 se limitan a menciones no evaluables.
...
El bloque exige resolver integración, seguridad, operación, accesibilidad, comunicación y analítica de los sistemas complementarios. Solo ALB e IFZ presentan desarrollo general; los otros dieciocho sistemas se mencionan sin respuesta técnica suficiente.
...
**Análisis de la propuesta.** El contraste individual recogido en el anexo identifica 2 proyectos con desarrollo suficiente, 18 con desarrollo insuficiente y 0 sin solución concreta. Solo ALB e IFZ presentan desarrollo general; los otros dieciocho sistemas se mencionan sin respuesta técnica suficiente.

**Fortalezas y valor añadido.** Se reconoce contenido evaluable en 2 proyectos, que permite asignar valor parcial sin extenderlo a los proyectos no desarrollados.

**Carencias, omisiones, errores o riesgos.** 18 proyectos presentan desarrollo genérico o incompleto. Estas limitaciones reducen la concreción, viabilidad o verificabilidad del bloque.

**Valoración cualitativa: MUY BAJA.** El nivel **MUY BAJA** refleja la relación entre la cobertura efectiva, la profundidad técnica, las mejoras y las carencias acreditadas para el bloque.

##### Conclusión de los sistemas complementarios

La clasificación del anexo y las evidencias anteriores sitúan el bloque en un nivel **MUY BAJA**. Solo ALB e IFZ presentan desarrollo general; los otros dieciocho sistemas se mencionan sin respuesta técnica suficiente.
...
El bloque exige resolver mantenimiento, actualización, despliegue, respaldo y evolución de Wekan. WEK1 a WEK4 aparecen expresamente pendientes de desarrollo en una versión posterior de la memoria.
...
**Análisis de la propuesta.** El contraste individual recogido en el anexo identifica 0 proyectos con desarrollo suficiente, 0 con desarrollo insuficiente y 4 sin solución concreta. WEK1 a WEK4 aparecen expresamente pendientes de desarrollo en una versión posterior de la memoria.

**Fortalezas y valor añadido.** No se acreditan fortalezas técnicas suficientes ni mejoras verificables que excedan las obligaciones de base.

**Carencias, omisiones, errores o riesgos.** 4 carecen de solución concreta. Estas limitaciones reducen la concreción, viabilidad o verificabilidad del bloque.

**Valoración cualitativa: MUY BAJA.** El nivel **MUY BAJA** refleja la relación entre la cobertura efectiva, la profundidad técnica, las mejoras y las carencias acreditadas para el bloque.

##### Conclusión del bloque WEK

La clasificación del anexo y las evidencias anteriores sitúan el bloque en un nivel **MUY BAJA**. WEK1 a WEK4 aparecen expresamente pendientes de desarrollo en una versión posterior de la memoria.

### Conclusión del análisis detallado

TRA recibe un tratamiento general; AV y MED contienen numerosos apartados pendientes; COR, CLO, VID y la mayoría de servicios unitarios y complementarios se limitan a menciones; WEK queda íntegramente pendiente. La falta de finalización y de adaptación al entorno es transversal, no una deficiencia aislada. Predominan las menciones sin desarrollo y los contenidos pendientes. Faltan arquitectura, desglose de tareas, cronograma, dependencias, hitos, recursos, métricas, criterios de aceptación y procedimientos de recuperación verificables. La cobertura efectiva y la trazabilidad son, por ello, muy reducidas.
...
La arquitectura se mantiene en un plano conceptual y no define de forma evaluable componentes, relaciones, integraciones, despliegues, seguridad ni resiliencia para la mayor parte de los proyectos.

**Nivel cualitativo:** BAJA
**Puntuación:** 0,30 sobre 2,00

### Grado de comprensión de los requisitos planteados — máximo 2 puntos

La presencia de numerosos apartados pendientes y menciones genéricas impide acreditar una interpretación completa y adaptada del Anexo II.
...
No se detallan recursos, dependencias, procedimientos de implantación ni continuidad suficientes; la viabilidad no queda demostrada.

**Nivel cualitativo:** BAJA
**Puntuación:** 0,20 sobre 1,00

### Metodología de trabajo aplicada — máximo 1 punto

La exposición metodológica tiene valor formal y recoge conceptos aplicables, pero no se vincula operativamente con los proyectos, tareas y entregables del contrato.
...
No se aportan métricas, pruebas de carga, escenarios, monitorización ni criterios de aceptación que permitan estimar el rendimiento.
...
Solo 22 de 85 proyectos presentan desarrollo general, 37 se limitan a menciones insuficientes y 26 no contienen solución concreta por quedar pendientes. La cobertura efectiva es muy reducida.

**Nivel cualitativo:** BAJA
**Puntuación:** 0,80 sobre 8,00
...
Se recogen referencias conceptuales, pero sin vinculación sistemática a proyectos, responsables, indicadores y seguimiento.
...
Las contingencias no se definen en términos evaluables; faltan escenarios, activadores, tiempos, pruebas y retorno a la normalidad.
...
Se reconocen principios metodológicos de calidad, pero no se traducen en indicadores, criterios de aceptación, auditorías y controles aplicables al servicio.
...
Las referencias conceptuales no constituyen un modelo verificable que conecte requisitos, tareas, entregables y evidencias.
...
La puntuación consolidada de 3,70 puntos refleja de forma proporcionada la cobertura, profundidad, viabilidad y planificación acreditadas. La calidad global es muy insuficiente. La oferta obtiene 3,70 puntos sobre 30 y no alcanza el umbral mínimo de 15 puntos; procede proponer su exclusión.

## CONCLUSIONES FINALES Y PROPUESTA

### Conclusiones globales de la evaluación técnica

La propuesta presenta un desarrollo técnico muy limitado y desigual. Una parte sustancial de los proyectos aparece solo mencionada o marcada como pendiente de una versión futura; no se aportan arquitecturas completas, secuencias de implantación, integraciones, métricas ni mecanismos de validación suficientes. Se reconocen referencias conceptuales a metodología, riesgos y calidad y algún desarrollo general en proyectos concretos, pero no permiten acreditar la cobertura ni la viabilidad global. La calidad global es muy insuficiente. La oferta obtiene 3,70 puntos sobre 30 y no alcanza el umbral mínimo de 15 puntos; procede proponer su exclusión.
...
No existe diagrama de Gantt ni una planificación operativa con fechas, duraciones, dependencias, hitos, recursos o correspondencia completa con los subproyectos. Se recogen referencias conceptuales, pero sin vinculación sistemática a proyectos, responsables, indicadores y seguimiento. Las contingencias no se definen en términos evaluables; faltan escenarios, activadores, tiempos, pruebas y retorno a la normalidad. Se reconocen principios metodológicos de calidad, pero no se traducen en indicadores, criterios de aceptación, auditorías y controles aplicables al servicio. Las referencias conceptuales no constituyen un modelo verificable que conecte requisitos, tareas, entregables y evidencias.

### Justificación de la valoración

Las puntuaciones parciales trasladan el nivel efectivamente acreditado en cada subcriterio, sin compensar omisiones estructurales con fortalezas puntuales. El resultado de 2,20 puntos en solución y 1,50 en planificación es coherente con el análisis y con el total de 3,70 puntos.
...
La clasificación muestra 22 proyectos con desarrollo suficiente, 37 insuficientes y 26 sin solución concreta. Se identifican 0 proyectos con errores relevantes y 0 con valor añadido verificable. TRA recibe un tratamiento general; AV y MED contienen numerosos apartados pendientes; COR, CLO, VID y la mayoría de servicios unitarios y complementarios se limitan a menciones; WEK queda íntegramente pendiente. La falta de finalización y de adaptación al entorno es transversal, no una deficiencia aislada. El anexo aporta trazabilidad, mientras que la puntuación deriva de la valoración conjunta de todos los subcriterios.
