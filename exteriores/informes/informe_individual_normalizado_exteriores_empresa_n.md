...
El patrón dominante es un desarrollo insuficiente o genérico en una parte mayoritaria de los subproyectos. Las carencias se repiten en ELIF, MoodleMisc, Dinámicas, integración, sistemas externos y desarrollo seguro; IFP y algunos proyectos concretos alcanzan un desarrollo suficiente. La ausencia de ESIS11 y ESIS14, junto con la limitada planificación del segundo año contractual, constituye una deficiencia relevante y no un hecho aislado.
...
**La propuesta reproduce en gran medida los objetivos perseguidos por el propio requisito y presenta un nivel de detalle similar al observado en otros subproyectos clasificados como desarrollo deficiente.** Esta circunstancia resulta coherente con la clasificación recogida en el Anexo I.

**Aunque el requisito se encuentra formalmente cubierto, la escasa profundidad técnica de la solución impide acreditar una capacidad diferencial de prestación del servicio solicitado.** La respuesta se ajusta a los parámetros correspondientes a una valoración BAJA.
...
El bloque presenta 8 subproyectos con desarrollo suficiente, 21 con desarrollo insuficiente y 2 no incluidos. El contraste conjunto de las evidencias, fortalezas y carencias sitúa su valoración cualitativa en **BAJA**.
...
| Comprensión de los requisitos | 2,00 | ALTA | 1,30 |
| Viabilidad | 1,00 | MEDIA | 0,55 |
| Metodología | 1,00 | BAJA | 0,30 |
...
| **Subcriterio** | **Máximo** | **Nivel** | **Puntuación** |
| --- | ---: | --- | ---: |
| Calendario y planificación temporal | 11,00 | BAJA | 1,10 |
| Análisis de riesgos | 1,00 | MEDIA | 0,45 |
| Plan de contingencias | 1,00 | MEDIA | 0,45 |
| Plan de calidad | 1,00 | MEDIA | 0,35 |
| Trazabilidad | 1,00 | BAJA | 0,30 |
| **TOTAL PLANIFICACIÓN** | **15,00** |  | **2,65** |
...
La planificación obtiene **2,65 puntos sobre 15**. Su resultado refleja el grado de detalle temporal, la relación con los subproyectos y la formalización de riesgos, contingencias, calidad y trazabilidad descritos en el análisis.
...
La propuesta de **empresa_n** obtiene una puntuación de **9,90 puntos sobre 30** en los criterios sujetos a juicio de valor.
...
| ESIS25 | INSUFICIENTE | NO | NO | Desarrollo genérico o insuficientemente concretado. |
| ESIS26 | INSUFICIENTE | NO | NO | Desarrollo genérico o insuficientemente concretado. |
...
| ESIS31 | INSUFICIENTE | NO | NO | Desarrollo genérico o insuficientemente concretado. |
...
| --- | ---: | ---: |
| No incluidos | 2 | 3,77 % |
| Desarrollo insuficiente o deficiente | 29 | 54,72 % |
| Desarrollo suficiente | 22 | 41,51 % |
...
| Con propuesta de mejora sin valor añadido real | 7 | 13,21 % |
| Con propuesta de mejora con valor añadido real | 11 | 20,75 % |
