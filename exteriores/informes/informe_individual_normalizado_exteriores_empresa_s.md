...
La propuesta presenta una cobertura completa y un nivel de desarrollo global elevado, con arquitecturas reconocibles, metodologías de migración e integración estructuradas y una adaptación consistente a los entornos Liferay, Drupal, Moodle, Dinámicas, sistemas externos y seguridad. Incorpora mejoras reales en automatización, identidades, aprovisionamiento, observabilidad y DevSecOps. Las principales limitaciones se concentran en la escasez de métricas cuantificables, la identificación incompleta de herramientas y el nivel de detalle operativo de la planificación.

### Principales conclusiones del análisis

La oferta mantiene una cobertura homogénea de ELIF, IFP, EMOM, EDIN, EIPE, ESIS, ESEG, EDSA y EBBO. Predominan los desarrollos suficientes y las mejoras, con especial solidez en IFP, MoodleMisc, identidades, aprovisionamiento, continuidad y seguridad. Las carencias de métricas, criterios de aceptación, herramientas concretas y formalización temporal son recurrentes, pero no comprometen la viabilidad global.

### Resultado de la valoración

| **Bloque**                 | **Puntuación máxima** | **Puntuación obtenida** |
| -------------------------- | --------------------: | ----------------------: |
| Solución técnica ofertada  |                 15,00 |                   10,85 |
| Planificación del servicio |                 15,00 |                    7,85 |
| **TOTAL**                  |             **30,00** |               **18,70** |

### Conclusión del resumen ejecutivo

La oferta alcanza un nivel técnico alto: cubre todo el alcance, demuestra conocimiento del entorno y desarrolla soluciones viables con mejoras relevantes. La falta de métricas, herramientas concretas y detalle temporal impide una valoración excelente, pero no afecta de forma estructural a la capacidad de ejecución acreditada. La oferta obtiene **18,70 puntos sobre 30** y alcanza el umbral mínimo de 15 puntos.

## INTRODUCCIÓN

### Alcance del informe

El presente informe evalúa la memoria técnica presentada por **empresa_s** para la prestación de los **Servicios de mantenimiento y soporte para proyectos exteriores alojados en la plataforma EducaMadrid (BAC01_2026)**. El análisis comprende tanto la **solución técnica ofertada** como la **planificación del servicio**, de acuerdo con los criterios sujetos a juicio de valor establecidos en el apartado 7.2 del Documento de Invitación.
...
La memoria está completa, ordenada por bloques y mantiene una relación coherente entre el diagnóstico del entorno, las soluciones y las prácticas de implantación. La arquitectura y los procedimientos se describen con suficiente amplitud para una valoración técnica, aunque la trazabilidad hacia entregables, métricas, herramientas y criterios de aceptación no es uniforme en todos los subproyectos.

#### Nivel de desarrollo técnico y grado de concreción

La oferta transforma la mayoría de los requisitos en soluciones técnicas reconocibles y coherentes, con procedimientos de migración, integración, despliegue, seguridad y operación adaptados al entorno. Las fortalezas son extensas y existen aportaciones de valor añadido, aunque la verificabilidad queda limitada por la falta recurrente de métricas y por una planificación temporal todavía conceptual.
...
De los 53 subproyectos del Anexo II, 45 se clasifican con desarrollo suficiente, 8 con desarrollo insuficiente o deficiente y 0 como no incluidos. La clasificación describe la cobertura documental y se interpreta conjuntamente con la calidad, la coherencia, la viabilidad y la verificabilidad de cada solución.
...
El bloque presenta 3 subproyectos con desarrollo suficiente, 1 con desarrollo insuficiente y 0 no incluidos. El contraste conjunto de las evidencias, fortalezas y carencias sitúa su valoración cualitativa en **ALTA**.
...
El bloque presenta 1 subproyectos con desarrollo suficiente, 0 con desarrollo insuficiente y 0 no incluidos. El contraste conjunto de las evidencias, fortalezas y carencias sitúa su valoración cualitativa en **ALTA**.
...
El bloque presenta 5 subproyectos con desarrollo suficiente, 2 con desarrollo insuficiente y 0 no incluidos. El contraste conjunto de las evidencias, fortalezas y carencias sitúa su valoración cualitativa en **ALTA**.
...
El bloque presenta 1 subproyectos con desarrollo suficiente, 1 con desarrollo insuficiente y 0 no incluidos. El contraste conjunto de las evidencias, fortalezas y carencias sitúa su valoración cualitativa en **MEDIA**.
...
El bloque presenta 2 subproyectos con desarrollo suficiente, 0 con desarrollo insuficiente y 0 no incluidos. El contraste conjunto de las evidencias, fortalezas y carencias sitúa su valoración cualitativa en **ALTA**.
...
La oferta original concreta un **modelo centralizado y gobernado de integración segura** con APIs securizadas, control centralizado de accesos, autenticación federada, trazabilidad, validación continua de integraciones, correlación de eventos y hardening automatizado. Esta evidencia respalda la observación del anexo y del CSV.
...
La oferta original propone un modelo automatizado y gobernado de validación de aplicativos mediante **Ansible, contenedores, plantillas reutilizables, pipelines CI/CD y pruebas automáticas de integración, compatibilidad y seguridad**. Esta evidencia respalda la observación del anexo y del CSV.
...
**No obstante, aunque se identifican Ansible, contenedores y pipelines CI/CD, no se define su arquitectura de implantación, configuración, gobierno ni integración con las plataformas corporativas.** Del mismo modo, no se establecen métricas asociadas a los tiempos de despliegue, indicadores de validación o criterios cuantificables de aceptación, lo que limita la capacidad de evaluar la eficiencia y eficacia del proceso.
...
La oferta original define una plataforma avanzada de **administración centralizada y automatizada de bases de datos**, con inventario y trazabilidad de cambios, observabilidad, detección de anomalías, aprovisionamiento automatizado, segregación de privilegios y auditoría de accesos. Esta evidencia respalda la observación del anexo y del CSV.
...
La oferta original propone una plataforma centralizada de **aprovisionamiento automatizado y gobernado**, con solicitudes automáticas, plantillas reutilizables, despliegues homogéneos, capacity planning continuo, inventario y control de cambios. Esta evidencia respalda la observación del anexo y del CSV.
...
Sin embargo, aunque se propone una plataforma centralizada con automatización y plantillas de aprovisionamiento, no se concretan los circuitos de aprobación, la herramienta de implantación ni la integración con los sistemas corporativos, lo que reduce la concreción operativa de la solución.
...
La oferta original concreta **infraestructura como código**, plantillas reutilizables endurecidas, automatización con Ansible y **auditoría automática de configuraciones**, junto con verificación continua ENS/STIC y detección de desviaciones. Esta evidencia respalda la observación del anexo y del CSV.
...
La oferta original propone evolucionar la integración LDAP hacia un modelo centralizado de **Identity Governance**, con reconciliación automática de atributos, observabilidad de autenticación, trazabilidad, MFA para servicios críticos y control Zero Trust sobre conectores. Esta evidencia respalda la observación del anexo y del CSV.
...
La oferta original contempla **snapshots bloqueados, repositorios WORM, replicación entre CPD, recuperación geográfica y failover de servicios críticos**, además de orquestación de recuperación. Esta evidencia respalda la observación del anexo y del CSV.
...
Sin embargo, aunque se concretan repositorios WORM, replicación entre CPD, failover y orquestación, no se definen los RPO y RTO, la topología, los productos de respaldo ni los criterios y resultados de las pruebas automatizadas de recuperación, lo que limita la verificabilidad.
...
La oferta original desarrolla un modelo de observabilidad integral con **inteligencia operacional**, análisis predictivo, identificación automática de causas raíz e **integración con SOC y ciberseguridad** para correlacionar rendimiento, seguridad y experiencia de usuario. Esta evidencia respalda la observación del anexo y del CSV.

La propuesta sí introduce observabilidad inteligente, correlación avanzada, análisis predictivo e integración con SOC; no obstante, no concreta la pila de herramientas, la arquitectura desplegada, los casos de uso, los umbrales ni los indicadores de eficacia.
...
La oferta original concreta **MFA unificado**, control de privilegios, hardening, verificación continua ENS/STIC, dashboards de seguridad y **reporting ENS**, además de gestión recurrente de vulnerabilidades. Esta evidencia respalda la observación del anexo y del CSV.
...
La oferta original propone un modelo continuo de **defensa activa y observabilidad inteligente**, con integración SOC/SIEM, análisis de comportamiento, Zero Trust, MFA contextual, hardening STIC y reporting ENS. Esta evidencia respalda la observación del anexo y del CSV.

La propuesta incorpora integración SOC/SIEM, análisis de comportamiento, Zero Trust, hardening STIC y mecanismos avanzados de detección; permanece abierta la selección y arquitectura de las herramientas, los casos de uso, los umbrales y los procedimientos operativos de respuesta.
...
La oferta original define una **gestión proactiva del ciclo de vida tecnológico**, con identificación temprana de componentes obsoletos, migraciones anticipadas, despliegues automatizados, prevalidación, control centralizado de versiones y alertas de riesgo tecnológico. Esta evidencia respalda la observación del anexo y del CSV.

No obstante, aunque se definen políticas de gestión preventiva de EOL, automatización, prevalidación y control de versiones, no se concretan las herramientas, el inventario de partida, las periodicidades, los umbrales ni las métricas de éxito.
...
La oferta original desarrolla un **modelo integral de gobierno técnico** con seguimiento centralizado de dependencias y riesgos, KPI automáticos, paneles de estado, reporting técnico y ejecutivo, gestión del conocimiento y trazabilidad completa de cambios. Esta evidencia respalda la observación del anexo y del CSV.

La propuesta incorpora KPI automáticos, cuadros de mando y reporting técnico y ejecutivo, pero no concreta su catálogo, fórmulas, fuentes, umbrales, periodicidad ni criterios de aceptación.
...
La oferta original plantea **microsegmentación dinámica y seguridad adaptativa**, con control granular este-oeste, Zero Trust contextual, VPN segregada, MFA, certificados de cliente, DMZ, firewalls NGFW y observabilidad de accesos. Esta evidencia respalda la observación del anexo y del CSV.

Sin embargo, aunque se identifican Zero Trust, VPN, MFA, certificados, DMZ, NGFW, SIEM y Wazuh, no se aporta la arquitectura de partida y destino, las reglas de migración, el diseño lógico detallado ni los criterios verificables de aceptación.
...
La oferta original concreta una infraestructura **preparada para inteligencia artificial y GPU**, con vGPU, GPU passthrough, soporte CUDA/OpenCL, nodos especializados, autoscaling, despliegues IaC, capacity planning predictivo y evolución sobre plataformas KVM/OpenSource. Esta evidencia respalda la observación del anexo y del CSV.
...
El bloque presenta 29 subproyectos con desarrollo suficiente, 2 con desarrollo insuficiente y 0 no incluidos. El contraste conjunto de las evidencias, fortalezas y carencias sitúa su valoración cualitativa en **ALTA**.
...
La oferta original propone un sistema continuo de **validación ofensiva**, con pruebas OWASP manuales y automatizadas, explotación controlada, seguimiento de remediación, integración con Wazuh/SIEM y simulaciones Red Team. Esta evidencia respalda la observación del anexo y del CSV.
...
**La propuesta sí se alinea expresamente con OWASP y ENS y define pruebas manuales y automatizadas, explotación controlada, Red Team y validación posterior.** No obstante, no concreta el alcance por aplicación, las reglas de enfrentamiento, el calendario, los criterios de muestreo ni el procedimiento completo de aceptación de cada auditoría.

La integración con Wazuh/SIEM y el seguimiento de remediación aportan mecanismos concretos, pero no se identifican las herramientas ofensivas ni se definen métricas objetivo, tiempos de remediación o umbrales de riesgo. **Esta falta de parámetros limita la capacidad de evaluar el impacto de las actuaciones propuestas.**
...
La oferta original define expresamente un modelo **ASM (Attack Surface Management)** con descubrimiento automático de activos, supervisión continua de DNS, TLS y servicios públicos, hardening, integración con SIEM/Wazuh y paneles de exposición. Esta evidencia respalda la observación del anexo y del CSV.
...
**La propuesta identifica un modelo ASM, descubrimiento automático, supervisión DNS/TLS, hardening e integración con SIEM/Wazuh.** No obstante, no concreta el producto ASM, el algoritmo de priorización, los umbrales de exposición ni las métricas objetivo de reducción del riesgo.
...
El bloque presenta 2 subproyectos con desarrollo suficiente, 1 con desarrollo insuficiente y 0 no incluidos. El contraste conjunto de las evidencias, fortalezas y carencias sitúa su valoración cualitativa en **ALTA**.
...
La oferta original integra el análisis de código en un modelo **DevSecOps** con SAST, controles automáticos en pipelines CI/CD y herramientas como SonarQube, Semgrep, Dependency-Check y Trivy. Esta evidencia respalda la observación del anexo y del CSV.
...
**La propuesta identifica SAST, SonarQube, Semgrep, Dependency-Check y Trivy y se alinea con OWASP y DevSecOps.** No obstante, no concreta las reglas, los perfiles de análisis, los umbrales de bloqueo, la cobertura mínima ni las métricas de evolución de la calidad del código.
...
La oferta transforma la mayoría de los requisitos en soluciones técnicas reconocibles y coherentes, con procedimientos de migración, integración, despliegue, seguridad y operación adaptados al entorno. Las fortalezas son extensas y existen aportaciones de valor añadido, aunque la verificabilidad queda limitada por la falta recurrente de métricas y por una planificación temporal todavía conceptual. El resultado debe interpretarse conjuntamente con la clasificación individual del anexo y con la evaluación ponderada de los criterios del apartado 7.2.
...
En consecuencia, el grado de comprensión puede considerarse claramente superior al estándar medio. La puntuación consolidada de 1,75 sobre 2,00 equivale al 87,5 % y, conforme a la escala cerrada aplicada de forma homogénea, corresponde al nivel EXCELENTE.

**Nivel cualitativo:** EXCELENTE

**Puntuación:** 1,75 sobre 2,00
...
| Comprensión de los requisitos  |       2,00 | EXCELENTE |           1,75 |
| Viabilidad                     |       1,00 | ALTA      |           0,75 |
| Metodología                    |       1,00 | ALTA      |           0,60 |
| Rendimiento                    |       1,00 | MEDIA     |           0,50 |
| Satisfacción de los requisitos |       8,00 | ALTA      |           5,75 |
| **TOTAL SOLUCIÓN TÉCNICA**     |  **15,00** |           |      **10,85** |
...
| **Subcriterio**                     | **Máximo** | **Nivel** | **Puntuación** |
| ----------------------------------- | ---------: | --------- | -------------: |
| Calendario y planificación temporal |      11,00 | MEDIA     |           5,50 |
| Análisis de riesgos                 |       1,00 | ALTA      |           0,60 |
| Plan de contingencias               |       1,00 | ALTA      |           0,60 |
| Plan de calidad                     |       1,00 | ALTA      |           0,65 |
| Trazabilidad                        |       1,00 | MEDIA     |           0,50 |
| **TOTAL PLANIFICACIÓN**             |  **15,00** |           |       **7,85** |
...
| Solución técnica ofertada  |                 15,00 |                   10,85 |
| Planificación del servicio |                 15,00 |                    7,85 |
| **PUNTUACIÓN FINAL**       |             **30,00** |               **18,70** |

### Interpretación de la puntuación

La oferta alcanza un nivel técnico alto: cubre todo el alcance, demuestra conocimiento del entorno y desarrolla soluciones viables con mejoras relevantes. La falta de métricas, herramientas concretas y detalle temporal impide una valoración excelente, pero no afecta de forma estructural a la capacidad de ejecución acreditada. La puntuación mantiene la correspondencia con los niveles y resultados parciales consignados en las tablas anteriores.

## CONCLUSIONES FINALES Y PROPUESTA

### Conclusiones globales de la evaluación técnica

La oferta alcanza un nivel técnico alto: cubre todo el alcance, demuestra conocimiento del entorno y desarrolla soluciones viables con mejoras relevantes. La falta de métricas, herramientas concretas y detalle temporal impide una valoración excelente, pero no afecta de forma estructural a la capacidad de ejecución acreditada.

### Conclusiones sobre la solución técnica

La oferta transforma la mayoría de los requisitos en soluciones técnicas reconocibles y coherentes, con procedimientos de migración, integración, despliegue, seguridad y operación adaptados al entorno. Las fortalezas son extensas y existen aportaciones de valor añadido, aunque la verificabilidad queda limitada por la falta recurrente de métricas y por una planificación temporal todavía conceptual. La solución técnica obtiene **10,85 puntos sobre 15**.

### Conclusiones sobre la planificación del servicio

La planificación obtiene **7,85 puntos sobre 15**. Su resultado refleja el grado de detalle temporal, la relación con los subproyectos y la formalización de riesgos, contingencias, calidad y trazabilidad descritos en el análisis.
...
La propuesta de **empresa_s** obtiene una puntuación de **18,70 puntos sobre 30** en los criterios sujetos a juicio de valor.
...
| ELIF3        | SUFICIENTE              | NO                         | NO                          | Desarrollo técnico evaluable.                                               |
| ELIF4        | SUFICIENTE              | PM                         | NO                          | auditorías, revisiones, entornos no productivos, automatización de releases |
...
| EMOM3        | SUFICIENTE              | VA                         | NO                          | uso Redis para rendimiento                          |
| EMOM4        | SUFICIENTE              | NO                         | NO                          | Desarrollo técnico evaluable.                       |
| EMOM5        | INSUFICIENTE            | NO                         | NO                          | Desarrollo genérico o insuficientemente concretado. |
| EMOM6        | INSUFICIENTE            | NO                         | NO                          | Desarrollo genérico o insuficientemente concretado. |
| EMOM7        | SUFICIENTE              | VA                         | NO                          | integración selectiva SSO                           |
...
| ESIS3        | SUFICIENTE              | VA                         | NO                          | gobierno e integración de servicios avanzada                               |
| ESIS4        | SUFICIENTE              | PM                         | NO                          | modelo centralizado y gobernado de integración segura                      |
| ESIS5        | SUFICIENTE              | PM                         | NO                          | evolucionar la autenticación centralizada hacia una plataforma moderna     |
| ESIS6        | SUFICIENTE              | VA                         | NO                          | modernización y gobierno IAM                                               |
| ESIS7        | SUFICIENTE              | VA                         | NO                          | plataforma avanzada de gobierno y observabilidad de identidades            |
| ESIS8        | SUFICIENTE              | VA                         | NO                          | control IAM                                                                |
| ESIS9        | SUFICIENTE              | VA                         | NO                          | modelo automatizado y gobernado de validación de aplicativos               |
| ESIS10       | SUFICIENTE              | VA                         | NO                          | modelo DevSecOps                                                           |
| ESIS11       | SUFICIENTE              | VA                         | NO                          | plataforma avanzada de administración centralizada y automatizada de BBDD  |
| ESIS12       | SUFICIENTE              | VA                         | NO                          | capacity planning                                                          |
| ESIS13       | SUFICIENTE              | VA                         | NO                          | plataforma automatizada y gobernada de aprovisionamiento                   |
| ESIS14       | SUFICIENTE              | VA                         | NO                          | hardening con CIS/ENS                                                      |
| ESIS15       | SUFICIENTE              | VA                         | NO                          | DevSecOps e IaC                                                            |
| ESIS16       | SUFICIENTE              | VA                         | NO                          | automatización de configuraciones – IaC y auditoría automática de configs. |
| ESIS17       | SUFICIENTE              | VA                         | NO                          | Evolucionar LDAP a Identity Governance                                     |
| ESIS18       | SUFICIENTE              | PM                         | NO                          | seguridad SPF/DKIM                                                         |
| ESIS19       | SUFICIENTE              | VA                         | NO                          | gobierno y observabilidad de datos                                         |
| ESIS20       | SUFICIENTE              | VA                         | NO                          | gestión avanzada CMDB                                                      |
| ESIS21       | SUFICIENTE              | PM                         | NO                          | gobierno del conocimiento                                                  |
| ESIS22       | SUFICIENTE              | VA                         | NO                          | metodología MAGERIT                                                        |
| ESIS23       | SUFICIENTE              | VA                         | NO                          | repositorios WORM y replicación entre CPDs                                 |
| ESIS24       | INSUFICIENTE            | NO                         | NO                          | lo que incluye no supone una mejora o un valor añadido                     |
| ESIS25       | SUFICIENTE              | VA                         | NO                          | Inteligencia operacional e integración con SOC                             |
| ESIS26       | SUFICIENTE              | VA                         | NO                          | MFA unificado, hardening con pantillas STIC y reporting ENS                |
| ESIS27       | SUFICIENTE              | VA                         | NO                          | modelo continuo de defensa activa y observabilidad inteligente             |
| ESIS28       | SUFICIENTE              | VA                         | NO                          | gestión proactiva del ciclo de vida tecnológico:                           |
| ESIS29       | SUFICIENTE              | VA                         | NO                          | modelo integral de gobierno técnico                                        |
| ESIS30       | INSUFICIENTE            | PM                         | NO                          | microsegmentación y seguridad adaptativa                                   |
| ESIS31       | SUFICIENTE              | PM                         | NO                          | evolucionar virtualización a modelos preparados para la IA                 |
...
| ESEG3        | SUFICIENTE              | PM                         | NO                          | modelo ASM - Attack Surface Management  |
...
| ------------------------------------ | ----------------------: | -------------: |
| No incluidos                         |                       0 |         0,00 % |
| Desarrollo insuficiente o deficiente |                       8 |        15,09 % |
| Desarrollo suficiente                |                      45 |        84,91 % |
...
| Con propuesta de mejora sin valor añadido real |                      13 |                       24,53 % |
| Con propuesta de mejora con valor añadido real |                      27 |                       50,94 % |

### Conclusión del anexo

La oferta mantiene una cobertura homogénea de ELIF, IFP, EMOM, EDIN, EIPE, ESIS, ESEG, EDSA y EBBO. Predominan los desarrollos suficientes y las mejoras, con especial solidez en IFP, MoodleMisc, identidades, aprovisionamiento, continuidad y seguridad. Las carencias de métricas, criterios de aceptación, herramientas concretas y formalización temporal son recurrentes, pero no comprometen la viabilidad global. Esta clasificación aporta trazabilidad, pero la puntuación final deriva de la valoración conjunta de todos los criterios y no de un recuento automático de categorías.
