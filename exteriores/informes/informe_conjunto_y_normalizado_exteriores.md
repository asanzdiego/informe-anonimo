...
| Satisfacción | MEDIA — 4,00/8,00 | Los 25 desarrollos suficientes aportan contenido relevante en ELIF, IFP, MoodleMisc, sistemas, seguridad y desarrollo seguro, lo que permite el límite superior de MEDIA. No alcanza ALTA por carencias extensas en integración, Dinámicas y servicios externos y por la falta de solución concreta en ESIS11 y ESIS14. El recuento es auxiliar. |
| Calendario | BAJA — 1,80/11,00 | La oferta identifica tareas entre junio de 2026 y mayo de 2027, pero el Anexo II contempla dos años de contrato. La omisión del segundo año y la falta de duraciones, relaciones e hitos verificables justifican el nivel BAJA. |
...
A la vista de los resultados anteriores, se constata que la oferta presentada por empresa_s **supera el umbral mínimo previsto en el Documento de Invitación**, obteniendo una puntuación total de **18,70 puntos sobre 30**. Por el contrario, la oferta presentada por empresa_n obtiene **9,70 puntos sobre 30** y no alcanza el umbral de 15 puntos para continuar en el procedimiento.
