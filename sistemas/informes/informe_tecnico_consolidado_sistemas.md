# 1. INFORME TÉCNICO DE VALORACIÓN COMPARATIVA

**Procedimiento SDA26 – Sistemas EducaMadrid**

## 1.1. MARCO JURÍDICO Y BASE LEGAL DEL PROCEDIMIENTO DE VALORACIÓN

El presente informe se emite en el marco del procedimiento de contratación basado en el Sistema Dinámico de Adquisición SDA26, relativo a la contratación de los servicios de desarrollo evolutivo y correctivo del portal educativo, sistema LDAP, infraestructura cloud, sistema operativo MAX y restantes sistemas integrados en la plataforma EducaMadrid.

La evaluación de las ofertas presentadas se realiza conforme a lo dispuesto en la normativa vigente en materia de contratación pública, fundamentalmente en la **Ley 9/2017, de 8 de noviembre, de Contratos del Sector Público (LCSP)**, así como en los pliegos que rigen el procedimiento, y en particular el **Documento de Invitación (Documento de Invitación)**.

De acuerdo con lo establecido en el artículo 145 de la LCSP, la adjudicación del contrato se realiza atendiendo a una pluralidad de criterios de adjudicación basados en la mejor relación calidad-precio, incluyendo criterios evaluables mediante fórmulas y criterios sometidos a juicio de valor. En este sentido, el Documento de Invitación define expresamente los criterios cualitativos sometidos a valoración técnica, estableciendo sus pesos relativos, metodología de evaluación y escalas de puntuación.

En particular, el apartado 7.2 del Documento de Invitación regula los criterios de adjudicación cuya evaluación depende de un juicio de valor, estableciendo tanto los subcriterios a considerar como los rangos de puntuación aplicables. Este apartado constituye el marco de referencia fundamental para la evaluación técnica de las memorias presentadas por los licitadores.

Asimismo, el Documento de Invitación establece la existencia de un **umbral mínimo de calidad técnica**, consistente en la obtención de al menos el 50% de la puntuación máxima asignada a los criterios cualitativos, lo que implica la necesidad de alcanzar una puntuación mínima de 15 puntos sobre 30 para que la oferta pueda ser considerada en la siguiente fase del procedimiento. Este mecanismo responde al principio de garantía de la calidad mínima exigible en contratos de alta complejidad técnica.

La aplicación de estos criterios debe realizarse respetando en todo momento los principios generales de la contratación pública recogidos en el artículo 1 de la LCSP, entre los que destacan:
...
En este sentido, la evaluación técnica debe basarse en criterios objetivos, debidamente motivados y aplicados de forma homogénea a todas las ofertas, garantizando la trazabilidad entre las características de las propuestas analizadas y las puntuaciones finalmente asignadas.

El presente informe tiene por objeto aplicar de manera rigurosa estos principios, realizando un análisis técnico comparado de las ofertas presentadas, con base exclusiva en el contenido de sus memorias técnicas y en los criterios establecidos en el Documento de Invitación.

## 1.2. METODOLOGÍA DE VALORACIÓN DE LAS PROPUESTAS TÉCNICAS

La valoración de las propuestas técnicas presentadas por los licitadores se ha realizado conforme a lo establecido en el apartado 7.2 del Documento de Invitación, siguiendo un enfoque sistemático, detallado y trazable que permite garantizar la objetividad y coherencia del proceso evaluador.

### 1.2.1. Estructura general de la valoración
...
Ambos bloques son evaluados de forma independiente, si bien mantienen una relación directa en la medida en que la calidad de la solución técnica condiciona la viabilidad de la planificación planteada.

### 1.2.2. Valoración de la solución técnica ofertada
...
De todos los subcriterios, el de **satisfacción de requisitos** adquiere una relevancia especialmente significativa, al concentrar más del 50% de la puntuación del bloque.

La evaluación de este bloque se ha basado en un análisis exhaustivo del grado de cobertura de los subproyectos definidos en el Anexo II del Documento de Invitación, verificando para cada uno de ellos:

- el nivel de desarrollo técnico de la propuesta

- la existencia de procedimientos operativos definidos

- la identificación de herramientas concretas

- la coherencia entre los distintos componentes de la solución

- y su aplicabilidad real en un entorno de alta complejidad

Se ha prestado especial atención a la **verificabilidad de la solución**, entendida como la capacidad de demostrar objetivamente cómo se ejecutará el servicio mediante evidencias técnicas, métricas, automatización y mecanismos de control.

Asimismo, se han considerado como elementos de especial relevancia:

- la adaptación al entorno específico de EducaMadrid

- la capacidad de gestión a gran escala

- la integración entre sistemas heterogéneos

- y la orientación hacia la automatización y la mejora continua

### 1.2.3. Valoración de la planificación del servicio
...
Este segundo bloque evalúa la capacidad del licitador para organizar y estructurar la ejecución del servicio, atendiendo a los siguientes subcriterios:

- Planificación temporal del proyecto (diagrama de Gantt)
...
Dentro de este bloque, la planificación temporal adquiere un peso claramente dominante, representando más de dos tercios de la puntuación total.

La evaluación se ha centrado en verificar:

- el grado de detalle de la planificación

- la coherencia entre tareas, hitos y dependencias

- la adecuación a las ventanas operativas del entorno educativo

- la identificación de riesgos reales y su tratamiento

- la definición de mecanismos de control de calidad

- y la capacidad de seguimiento del servicio

Se ha considerado crítico que la planificación no se limite a una representación gráfica genérica, sino que constituya una herramienta real de gestión del servicio, alineada con la complejidad del entorno y con los requisitos operativos del contrato.

### 1.2.4. Escala de valoración cualitativa
...
Concretamente, la aplicación de esta escala se ha basado en los siguientes factores:

- grado de desarrollo técnico

- nivel de detalle y concreción

- existencia de herramientas y metodologías

- coherencia interna de la propuesta

- y capacidad de ejecución en condiciones reales

### 1.2.5. Principios de evaluación aplicados
...
La evaluación se apoya de forma directa en el análisis detallado de las memorias técnicas individuales de cada licitador, asegurando que todas las conclusiones recogidas en el presente documento son plenamente verificables y consistentes con la documentación analizada.

## 1.3. ANÁLISIS INDIVIDUAL DE LAS PROPUESTAS TÉCNICAS.

### 1.3.1. Propuesta técnica de empresa_s S.A.
...
### 1.3.2. Propuesta técnica de empresa_n

La propuesta técnica presentada por empresa_n presenta un enfoque marcadamente descriptivo, con una cobertura formal amplia de los distintos ámbitos funcionales del servicio, pero con un nivel de desarrollo técnico claramente insuficiente para responder a las exigencias del pliego.

Desde un punto de vista conceptual, la memoria identifica correctamente el alcance global del contrato y los distintos bloques funcionales que componen la plataforma EducaMadrid. Sin embargo, este reconocimiento no se traduce en una solución técnica desarrollada, sino que se materializa fundamentalmente en descripciones genéricas de actividades de mantenimiento, revisión y seguimiento.

A lo largo del análisis detallado se observa de forma reiterada que la propuesta:

- no define arquitecturas técnicas concretas

- no identifica herramientas específicas

- no desarrolla metodologías operativas

- y no establece métricas ni mecanismos de control del servicio

Este patrón se repite de manera sistemática en la práctica totalidad de los subproyectos analizados, lo que evidencia una carencia estructural en la propuesta técnica.

Especialmente relevantes son las deficiencias detectadas en los bloques técnicos clave, como:
...
- reutilización de contenidos no adaptados al subproyecto correspondiente

- referencia a tecnologías no alineadas con el entorno EducaMadrid

- desviaciones de contenido (por ejemplo, mezcla de herramientas distintas en subproyectos incorrectos)

Estas circunstancias afectan directamente a la credibilidad de la propuesta y evidencian un nivel de conocimiento del entorno que no resulta plenamente alineado con los requisitos del pliego.

Otro aspecto significativo es la ausencia de una verdadera propuesta de mejora. En la mayoría de los casos, las mejoras planteadas se limitan a ampliar las tareas ya descritas, sin introducir nuevos enfoques técnicos, metodologías ni soluciones innovadoras, lo que impide considerar la propuesta como evolutiva o diferenciadora.

En conjunto, la propuesta de empresa_n presenta un carácter claramente insuficiente desde el punto de vista técnico, con un desarrollo limitado, escasa concreción, ausencia de elementos verificables y deficiencias estructurales en múltiples ámbitos del servicio. Estas debilidades condicionan de forma determinante su valoración en los criterios de juicio de valor establecidos en el Documento de Invitación.

## 1.4. VALORACIÓN COMPARATIVA DE LAS PROPUESTAS TÉCNICAS

### 1.4.1. Introducción y síntesis comparativa
...
- empresa_s presenta una propuesta técnicamente consistente en los bloques principales, con carencias parciales

- empresa_n presenta una propuesta globalmente insuficiente, con deficiencias estructurales generalizadas

Esta diferencia condiciona de forma determinante la valoración en los criterios de juicio de valor, especialmente en aquellos relacionados con la satisfacción de requisitos y la viabilidad de la solución.

### 1.4.2. Valoración de la solución técnica ofertada

A continuación, se recoge la valoración comparativa de los subcriterios asociados a la solución técnica ofertada, conforme a lo establecido en el apartado 7.2 del Documento de Invitación.

### 1.4.3. Tabla 1. Valoración de la solución técnica ofertada (máximo 15 puntos)

| **Subcriterio** | **Ponderación** | **empresa_s (Valoración)** | **empresa_s (Puntos)** | **empresa_n (Valoración)** | **empresa_n (Puntos)** |
| --- | --- | --- | --- | --- | --- |
...
| Satisfacción requisitos | 8 | Alta | 6,00 | Muy baja | 2,00 |
| **TOTAL** | **15** |  | **11,05** |  | **5,05** |

### 1.4.4. Valoración de la planificación del servicio

En relación con la planificación del servicio, y dado el contenido analizado en ambos informes, se mantiene la coherencia con el patrón observado en la solución técnica, en la medida en que la calidad de la planificación se encuentra directamente condicionada por el nivel de desarrollo técnico de la propuesta.

### 1.4.5. Tabla 2. Valoración de la planificación del servicio (máximo 15 puntos)

| **Subcriterio** | **Ponderación** | **empresa_s (Valoración)** | **empresa_s (Puntos)** | **empresa_n (Valoración)** | **empresa_n (Puntos)** |
| --- | --- | --- | --- | --- | --- |
| Planificación (Gantt) | 11 | Media-Alta | 7,50 | Media | 5,00 |
...
### 1.4.6. Justificación de la valoración comparativa
...
En conjunto, la comparación pone de manifiesto una diferencia clara y objetiva entre ambas propuestas, basada en elementos verificables y evaluados de forma homogénea conforme a los criterios establecidos en el Documento de Invitación.

## 1.5. CONCLUSIONES DE LA VALORACIÓN COMPARADA
...
Desde esta perspectiva, la propuesta de empresa_s se configura como una solución técnicamente válida, con un grado de desarrollo suficiente en los bloques principales del servicio que permite acreditar su viabilidad en un entorno de alta complejidad como el de la plataforma EducaMadrid. En particular, la propuesta destaca por:

- la existencia de soluciones técnicas diferenciadas por tipología de sistema

- la utilización de herramientas concretas y metodologías estructuradas

- la orientación hacia la automatización, la observabilidad y la operación real

- y la coherencia global del planteamiento técnico en los ámbitos principales

No obstante, esta propuesta presenta también una serie de debilidades que han sido tenidas en cuenta en la valoración, entre las que destacan:

- la heterogeneidad en el nivel de desarrollo entre distintos bloques

- la falta de definición de métricas cuantificables y umbrales operativos

- la ausencia de desarrollo específico en determinados ámbitos del pliego

- y la falta de detalle técnico en algunos sistemas concretos

Estas circunstancias justifican que, si bien la propuesta alcanza valoraciones elevadas en determinados subcriterios, no llegue a niveles máximos o excelentes en la valoración global.

Por su parte, la propuesta presentada por empresa_n presenta una situación sustancialmente diferente. A pesar de identificar formalmente los distintos ámbitos del servicio, la solución planteada no alcanza el nivel de desarrollo técnico requerido para su ejecución efectiva, lo que se traduce en:

- ausencia de arquitecturas técnicas definidas

- falta de herramientas específicas

- inexistencia de metodologías operativas concretas
...
Como consecuencia de todo lo anterior, la valoración obtenida por empresa_n en los criterios de juicio de valor resulta sensiblemente inferior a la de empresa_s, especialmente en el subcriterio de satisfacción de requisitos, que constituye el elemento central de la evaluación técnica.

Desde una perspectiva global, puede afirmarse que:

- la propuesta de empresa_s presenta un nivel técnico adecuado, con carencias puntuales pero sin comprometer la viabilidad global del servicio

- la propuesta de empresa_n presenta deficiencias estructurales que afectan de forma significativa a su capacidad de ejecución

Esta diferencia se traduce en una puntuación total claramente diferenciada, resultado directo de la aplicación objetiva de los criterios establecidos en el Documento de Invitación.

En consecuencia, la comparación realizada permite concluir, de forma fundada y proporcional, que las propuestas no se sitúan en un nivel técnico equiparable, existiendo una diferencia sustancial en su grado de adecuación a los requisitos del contrato.

## 1.6. PROPUESTA DE EXCLUSIÓN Y CONTINUACIÓN DEL PROCEDIMIENTO

De conformidad con lo establecido en el Documento de Invitación, y en particular con lo dispuesto en relación con la exigencia de un umbral mínimo de calidad técnica, las ofertas presentadas deben alcanzar una puntuación mínima del 50% en los criterios evaluables mediante juicio de valor para poder continuar en el procedimiento de adjudicación.

Dado que la puntuación máxima asociada a dichos criterios es de 30 puntos, el umbral mínimo exigido se sitúa en **15 puntos**.
