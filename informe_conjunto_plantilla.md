...
### Propuesta técnica de [LICITADOR 1]

*Resumir la valoración individual de la oferta. Exponer, con apoyo en evidencias de la memoria, su comprensión del entorno, cobertura del Anexo II, arquitectura, viabilidad, metodología, rendimiento, satisfacción de requisitos y planificación. Identificar fortalezas y debilidades, distinguir carencias puntuales de deficiencias estructurales y cerrar con una valoración global coherente con la puntuación asignada.*

### Propuesta técnica de [LICITADOR 2]

*Repetir el mismo análisis y con el mismo nivel de exigencia aplicado al licitador anterior. Sustituir o duplicar este subapartado hasta incluir una sección por cada oferta presentada.*

## VALORACIÓN COMPARATIVA DE LAS PROPUESTAS TÉCNICAS

### Introducción y síntesis comparativa

*Comparar las ofertas de forma conjunta, explicando las diferencias relevantes en cobertura, desarrollo técnico, concreción, madurez, viabilidad, verificabilidad y capacidad de ejecución. Identificar la posición relativa de cada propuesta sin introducir información que no figure en sus memorias ni sustituir la motivación detallada de las tablas.*
...
*Motivar las diferencias reflejadas en las tablas. Relacionar cada puntuación con patrones de fortalezas y debilidades observados en las memorias, explicar por qué las ofertas quedan en niveles distintos y confirmar que se ha aplicado un estándar homogéneo. Evitar limitar la justificación a repetir las cifras.*

## CONCLUSIONES DE LA VALORACIÓN COMPARADA

*Sintetizar el resultado técnico de cada propuesta y las diferencias determinantes entre ellas. Indicar cuáles acreditan un nivel suficiente de calidad y cuáles presentan carencias que limitan su viabilidad o evaluabilidad. Confirmar la coherencia entre el análisis, la puntuación obtenida y los principios de objetividad, igualdad, proporcionalidad y trazabilidad.*

## PROPUESTA DE ADMISIÓN, EXCLUSIÓN Y CONTINUACIÓN DEL PROCEDIMIENTO

*Indicar la puntuación total obtenida por cada licitador, compararla expresamente con el umbral aplicable y formular la propuesta correspondiente. Identificar las ofertas que deben excluirse por no alcanzar el mínimo y aquellas con las que procede continuar, dejando claro que la decisión deriva de la aplicación de los criterios establecidos en la documentación reguladora del expediente.*
